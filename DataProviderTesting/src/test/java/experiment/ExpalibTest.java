...
public class ExpalibTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("searchinput")).sendKeys("Ocean"  ,Keys.ENTER);
		...
		driver.findElement(By.xpath("//a[@class='sale-btn group']//span[contains(text(),'Book Chor')]")).click();
		 ...
		 Iterator <String>   windoes = handles.iterator();
		 
		 String parent=windoes.next();
		 
		 String child=windoes.next();
