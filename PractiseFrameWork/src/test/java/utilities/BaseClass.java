...
//	}
	...
	public void tearDownMethod(ITestResult result) {
		if (result.getStatus() == ITestResult.SUCCESS) {
			...
			test.pass("Passed").addScreenCaptureFromPath(Screenshots.CaptureScreenShot(driver));
			 Screenshots.CaptureScreenShot(driver);
			...
			Screenshots.CaptureScreenShot(driver);
			test.fail("Failed ").addScreenCaptureFromPath(Screenshots.CaptureScreenShot(driver));
